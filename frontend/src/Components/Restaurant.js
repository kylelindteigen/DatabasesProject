...
export default class Restaurant extends Component {
	...
	render() {
		let apiKey = "AIzaSyCyNY9wczzLoKAGzvvCsKcEz20gOOKtqlI";
		return (
			...
			>
				<div className="row">
					...
					<div className="restaurant-img-container col-lg-6 col-12 d-flex justify-content-center align-items-center">
						<img
							className="img-fluid"
							src={`https://maps.googleapis.com/maps/api/streetview?size=200x200&location=${this.props.restaurant.lat},${apiKey}`}
							alt="restaurant view"
						/>
					</div>
				</div>
